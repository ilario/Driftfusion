...
%S_fun_str = ['[' S_potential ';' S_electron_hole ';' S_electron_hole '; 0; 0]'];
        FS_fun = str2func(['@(t,u,dudx,i,Fmat,g1_fun,g1_fun_arg,g2_fun,g2_fun_arg,Smat) deal([' F_potential ';' F_electron ';' F_hole ';' F_cation ';' F_anion '], [' S_potential ';' S_electron_hole ';' S_electron_hole '; 0; 0])']);
    else
        % S: Source terms
...
%S_fun_str = ['[' S_potential ';' S_electron_hole ';' S_electron_hole '; 0]'];
        FS_fun = str2func(['@(t,u,dudx,i,Fmat,g1_fun,g1_fun_arg,g2_fun,g2_fun_arg,Smat) deal([' F_potential ';' F_electron ';' F_hole ';' F_cation '], [' S_potential ';' S_electron_hole ';' S_electron_hole '; 0])']);
     
    end
else
    % S: Source terms
    S_potential = [q_over_eppmax_epp0 '*(-u(2)+u(3)-Smat(11,i)+Smat(12,i))'];
        FS_fun = str2func(['@(t,u,dudx,i,Fmat,g1_fun,g1_fun_arg,g2_fun,g2_fun_arg,Smat) deal([' F_potential ';' F_electron ';' F_hole '], [' S_potential ';' S_electron_hole ';' S_electron_hole '])']);
...
Smat = vertcat(int1gx1,gx1,int2gx2,gx2,B,ni_squared,taun,pt,taup,nt,NA,ND,Ncat,Nani);
    ...
    %dfpde = str2func(['@(x,t,u,dudx,i,Fmat,Smat,g1_fun,g1_fun_arg,g2_fun,g2_fun_arg) deal(' Cpre ',' S_fun_str ',' F_fun_str ')']);
...
function [C,F,S] = dfpde(x,t,u,dudx)
    ...
    i = (sampled_i-1)*sampling_step + find(x == x_ihalf_padded_mat(:,sampled_i));
        ...
        [F, S] = FS_fun(t,u,dudx,i,Fmat,g1_fun,g1_fun_arg,g2_fun,g2_fun_arg,Smat);
end
